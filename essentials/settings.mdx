...
description: 'Vodex.ai gives you complete control over the look and feel of your documentation using the docs.json file'
icon: 'gear'
---

Every Vodex.ai site needs a `docs.json` file with the core configuration settings. Learn more about the [properties](#properties) below.
...
<ResponseField name="topbarLinks" type="TopbarLink[]">
  ...
  <Expandable title="TopbarLink">
    ...
    The url once you click on the button. Example: `https://docs.vodex.ai`
    </ResponseField>
