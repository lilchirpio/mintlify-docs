...
|-----------|----------|-----------|-----------|---------|---------------|
| John | Smith | 555-123-4567 | $500.00 | 2024-03-30 | ACC12345 |
| Jane | Doe | 555-987-6543 | $750.00 | 2024-04-15 | ACC12346 |
| Mike | Johnson | 555-456-7890 | $300.00 | 2024-03-25 | ACC12347 |
...
| "Invalid date format" | Date column has wrong format | Convert to  stringify date format `March 25, 2025` |
| "Missing required column" | Required column is missing or misspelled | Add/fix firstname, lastname, phonenumber |
| "File too large" or "Exceeds capacity" | File contains more than 20,000 customers | Split into multiple files with max 20k each |
