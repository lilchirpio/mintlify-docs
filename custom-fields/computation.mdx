...
description: 'Learn how to use advanced computation features including math calculations, date operations, end-of-week, end-of-month, next-date, and date-range utilities in your custom fields'
tag: 'beta'
---
...
- Check that raw_today is available when using {today}
